...
3. [Local Navigation](#LocalNavigation)
4. [Editing Files](#EditingFiles)
...
## 3. <a name="LocalNavigation">Local Navigation</a>

### 3.1 Jump to line in current file

* CMD + L

### 3.2 Next / Previous method
...
### 3.6 Go to implementation

* CMD + ALT + B

### 3.7 Go to type declaration

* CMD + SHIFT + B

### 3.8 Go to super/parent
...
### 3.11 Show call hierarchy

* CONTROL + ALT + H

### 3.12 Show class member list

* CMD + F12



## 4. <a name="EditingFiles">Editing Files</a>
...
### 4.2 Sublime text multi selection (current select + next selection)

* CONTROL + G

### 4.3 Move lines up/down
...
### 4.13 Add missing methods

* CMD + I

### 4.14 Override methods

* CMD + O

### 4.15 Show documentation

* F1 (+ FN depending on settings)

### 4.16 Show parameter information

* CMD + P

### 4.17 Highlight every occurance of symbol in file

* CMD + SHIFT + F7 (+ FN depending on preferences)

### 4.18 Quick definition in popup
...
### 4.20 Generate / New File (in Project Window)
